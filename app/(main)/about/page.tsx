  ...
  const values = [
    {
      ...
      description:
        "Chúng tôi cam kết mang đến dịch vụ tốt nhất cho sinh viên với tiêu chuẩn chất lượng cao.",
    },
    {
      icon: Target,
      title: "Mục tiêu rõ ràng",
      description:
        "Giúp sinh viên tìm được nơi ở phù hợp với nhu cầu và ngân sách của mình.",
    },
    {
      icon: Award,
      title: "Uy tín hàng đầu",
      description:
        "Được tin tưởng bởi hàng nghìn sinh viên và các tòa nhà ký túc xá trên toàn quốc.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Nền tảng đặt phòng ký túc xá hiện đại, giúp sinh viên tìm kiếm và
              đặt phòng một cách dễ dàng và nhanh chóng
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 dark:text-gray-400 text-lg">
                <p>
                  KTX Online là nền tảng đặt phòng ký túc xá hàng đầu tại Việt
                  Nam, được thành lập với mục tiêu giúp sinh viên tìm kiếm và
                  đặt phòng ký túc xá một cách dễ dàng, nhanh chóng và tiện lợi.
                </p>
                <p>
                  Với hơn 500 tòa nhà ký túc xá đối tác trên toàn quốc, chúng
                  tôi tự hào mang đến cho sinh viên nhiều lựa chọn phù hợp với
                  mọi nhu cầu và ngân sách.
                </p>
                <p>
                  Đội ngũ của chúng tôi luôn nỗ lực không ngừng để cải thiện
                  dịch vụ, mang đến trải nghiệm tốt nhất cho người dùng.
                </p>
              </div>
            </div>
            <div className="bg-brand rounded-2xl p-8 text-white">
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <span>
                    Kết nối sinh viên với các tòa nhà ký túc xá chất lượng
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 flex-shrink-0 mt-1" />
                  <span>
                    Mang đến trải nghiệm đặt phòng đơn giản, nhanh chóng
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 flex-shrink-0 mt-1" />
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Những lý do khiến KTX Online trở thành lựa chọn hàng đầu của sinh
              viên
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
