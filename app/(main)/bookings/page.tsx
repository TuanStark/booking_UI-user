            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl leading-relaxed">
                ...
                <span className="font-bold text-slate-900 dark:text-white">
                  {stats.active} đơn đặt phòng
                </span>{" "}
                đang hoạt động và {stats.pending} đơn chờ xử lý.
              </p>
            </div>
        ...
        {loading ? (
          <div className="grid gap-6">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="h-44 rounded-3xl bg-white dark:bg-[#1E293B] animate-pulse border border-slate-200 dark:border-slate-800"
              ></div>
            ))}
          </div>
          ...
          <div className="bg-white dark:bg-[#1E293B] rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none p-16 text-center border border-slate-100 dark:border-slate-800 max-w-2xl mx-auto">
            ...
            <p className="text-slate-500 dark:text-slate-400 mb-10 text-lg">
              Bạn chưa có đơn đặt phòng nào trong danh mục này. Hãy bắt đầu hành
              trình của bạn bằng cách chọn một phòng ưng ý nhé!
            </p>
            <Link
              href="/buildings"
              className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-brand text-white font-bold shadow-xl shadow-brand/20 hover:bg-brand-dark hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
            >
...
function BookingCard({
  ...
  booking: BookingSummary & { room?: any };
}) {
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-10 xl:border-l xl:border-slate-100 dark:xl:border-slate-800 xl:pl-10">
            <div className="grid grid-cols-2 gap-8 md:gap-12">
              ...
              <div className="space-y-1">
                ...
                <p className="text-blue-600 dark:text-blue-400 font-extrabold text-lg">
              ...
              <div className="lg:col-span-7 space-y-8">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  ...
                  <MetricCard
                    icon={Users}
                    label="Sức chứa"
                    value={`${roomDetail.capacity} người`}
                  />
                  <MetricCard
                    icon={Bed}
                    label="Giường"
                    value={roomDetail.beds}
                  />
                  <MetricCard
                    icon={Bath}
                    label="Phòng tắm"
...
> = {
  ...
  CANCELLED: {
    ...
    badgeClass:
      "bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400 ring-rose-500/20",
    icon: XCircle,
  },
};
